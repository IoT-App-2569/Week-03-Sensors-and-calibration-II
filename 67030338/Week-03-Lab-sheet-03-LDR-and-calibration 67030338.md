...
![](../messageImage_1784180436441.jpg)
7. คัดลอกสมการ $y = ...$ ไปใช้ในโปรแกรม
8. คำตอบคือ$$3.0326e^{0.0014x}$$
...
>ANS อยู่ในระดับที่ยอมรับได้ในเกณฑ์น่าพอใจสำหรับการใช้งานทั่วไป
- สมการ Linear หรือ Polynomial เหมาะกว่ากัน
>ANS สมการ Polynomial (รวมถึง Exponential/Power Law) มีความเหมาะสมและแม่นยำกว่าสมการ Linear มาก

## **ส่วนที่ 8 — คำถามท้ายใบงาน**

1. ทำไมต้องใช้ Voltage Divider ในการอ่าน LDR? 
> เพราะไมโครคอนโทรลเลอร์อ่านได้แค่แรงดัน (Voltage) วงจรนี้จึงช่วยแปลง **"ความต้านทานที่เปลี่ยนตามแสง"** ให้กลายเป็น **"แรงดัน"** ที่ ADC สามารถวัดค่าได้
2. ทำไมต้องเก็บข้อมูลหลายจุดก่อนทำ Calibration?
>เพราะค่า LDR กับความเข้มแสงไม่ได้เปลี่ยนเป็นเส้นตรง (Non-linear) การเก็บข้อมูลหลายจุดจึงช่วยให้สร้าง **สมการคำนวณ** ที่แม่นยำและครอบคลุมทุกช่วงแสงได้จริง
3. ถ้า Noise มากกว่าสัญญาณจริง จะเกิดอะไรขึ้น?
>ค่า ADC จะแกว่งรุนแรงจนคำนวณค่า Lux ผิดพลาด ส่งผลให้ระบบปลายทาง (เช่น การเปิด-ปิดไฟอัตโนมัติ) **ทำงานรวนและตอบสนองผิดพลาด**
4. ทำไมการวางตำแหน่งเซนเซอร์จึงสำคัญต่อ Signal Integrity?
>เพื่อลดสัญญาณรบกวนทางไฟฟ้า (EMI) จากสายที่ยาวเกินไป และเพื่อให้เซนเซอร์รับแสงได้ตรงตามจริง โดยไม่ถูกเงาบังหรือมีแสงสะท้อนภายนอกมาทำให้ค่าคลาดเคลื่อน
5. ถ้า ADC มี Resolution ต่ำ จะส่งผลอย่างไรต่อความแม่นยำ?
>ค่าที่อ่านได้จะ "หยาบ" ขึ้น (ขั้นบันไดของข้อมูลกว้างเกินไป) ทำให้ **ไม่สามารถแยกแยะการเปลี่ยนแปลงของแสงเพียงเล็กน้อยได้** ความละเอียดในการวัดจึงลดลงอย่างมาก
...
| ข้อ | รายการ                              | คะแนน<br>(0–5 คะแนน) | เหตุผล |
| --- | ----------------------------------- | -------------------- | ------ |
| 2.1 | ต่อวงจร Voltage Divider ได้ถูกต้อง  | 3                    |        |
...
| 3.2 | วัดค่า Lux จากมือถือได้ถูกต้อง     | 3                    |        |
| 3.3 | จดข้อมูลเป็นตารางครบถ้วน           | 5                    |        |
| 3.4 | ควบคุมสภาพแสงให้คงที่ระหว่างการวัด | 2                    |        |
...
| ข้อ | รายการ                                        | คะแนน<br>(0–5 คะแนน) | เหตุผล |
| --- | --------------------------------------------- | -------------------- | ------ |
| 4.1 | สร้างกราฟ Scatter ADC vs Lux ได้              | 4                    |        |
| 4.2 | เลือก Trendline เหมาะสม (Linear / Polynomial) | 5                    |        |
| 4.3 | อ่านสมการจากกราฟได้ถูกต้อง                    | 3                    |        |
| 4.4 | นำสมการไปใช้ในโค้ดได้                         | 4                    |        |
| 4.5 | วิเคราะห์ว่า Linear หรือ Polynomial เหมาะกว่า | 2                    |        |
### **ส่วนที่ 10.5 — การทดสอบผลลัพธ์และวิเคราะห์ (15 คะแนน)**

| ข้อ | รายการ                                   | คะแนน<br>(0–5 คะแนน) | เหตุผล |
| --- | ---------------------------------------- | -------------------- | ------ |
| 5.1 | ทดสอบจุดแสงใหม่ที่ไม่ได้ใช้ตอนเก็บข้อมูล | 3                    |        |
| 5.2 | เปรียบเทียบ Lux มือถือ vs Lux จากโค้ด    | 4                    |        |
| 5.3 | วิเคราะห์ความคลาดเคลื่อนและสาเหตุได้     | 3                    |        |
.................................................................
...
1. จุดไหนในใบงานที่คิดว่ายากที่สุด? การวัดระดับค่าแสง.
    
2. ถ้าทำใบงานนี้อีกครั้ง จะปรับปรุงอะไร? ปรับปรุงการเก็บค่าให้ละเอียด
    
3. ส่วนไหนที่คิดว่าตนเองเข้าใจดีมาก? ส่วนกราฟ
