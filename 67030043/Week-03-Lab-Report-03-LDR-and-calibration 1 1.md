...
พิจารณาจากค่า Error, RMSE หรือเปอร์เซ็นต์ความคลาดเคลื่อน หากมีค่าน้อยและอยู่ในเกณฑ์ที่กำหนดสำหรับงานนั้น ถือว่ายอมรับได้
- สมการ Linear หรือ Polynomial เหมาะกว่ากัน
พิจารณาจากค่า Error, RMSE หรือเปอร์เซ็นต์ความคลาดเคลื่อน หากมีค่าน้อยและอยู่ในเกณฑ์ที่กำหนดสำหรับงานนั้น ถือว่ายอมรับได้
## **ส่วนที่ 8 — คำถามท้ายใบงาน**

1. ทำไมต้องใช้ Voltage Divider ในการอ่าน LDR?
LDR (Light Dependent Resistor) เป็นตัวต้านทานที่เปลี่ยนค่าความต้านทานตามความเข้มแสง ซึ่งไมโครคอนโทรลเลอร์ไม่สามารถวัดค่าความต้านทานได้โดยตรง จึงต้องใช้วงจร Voltage Divider ร่วมกับตัวต้านทานคงที่ เพื่อแปลงค่าความต้านทานของ LDR ให้เป็นแรงดันไฟฟ้าที่ ADC สามารถวัดและแปลงเป็นข้อมูลดิจิทัลได้
2. ทำไมต้องเก็บข้อมูลหลายจุดก่อนทำ Calibration?
การเก็บข้อมูลหลายจุดช่วยให้เห็นความสัมพันธ์ระหว่างค่าที่วัดได้กับค่าจริงตลอดช่วงการทำงานของเซนเซอร์ ทำให้สามารถสร้างสมการ Calibration ที่มีความแม่นยำมากขึ้น ลดความคลาดเคลื่อนจากการวัด และช่วยตรวจสอบแนวโน้มของข้อมูลว่ามีลักษณะเชิงเส้น (Linear) หรือไม่
3. ถ้า Noise มากกว่าสัญญาณจริง จะเกิดอะไรขึ้น?
เมื่อ Noise มีขนาดมากกว่าสัญญาณจริง ข้อมูลที่วัดได้จะมีความผันผวนสูงและไม่สะท้อนค่าจริงของปรากฏการณ์ที่ต้องการวัด ส่งผลให้การวิเคราะห์ข้อมูลผิดพลาด การ Calibration ไม่มีความแม่นยำ และระบบควบคุมหรือการตัดสินใจที่อาศัยข้อมูลดังกล่าวอาจทำงานผิดพลาดได้
4. ทำไมการวางตำแหน่งเซนเซอร์จึงสำคัญต่อ Signal Integrity?
ตำแหน่งติดตั้งเซนเซอร์มีผลโดยตรงต่อคุณภาพของสัญญาณ หากติดตั้งในตำแหน่งที่มีสัญญาณรบกวนสูง อยู่ไกลจากแหล่งวัด หรือมีสิ่งกีดขวาง อาจทำให้ข้อมูลที่ได้ไม่ตรงกับสภาพจริง ส่งผลให้ความถูกต้องและความน่าเชื่อถือของข้อมูลลดลง ดังนั้นการเลือกตำแหน่งที่เหมาะสมจะช่วยให้ได้สัญญาณที่มีคุณภาพและลดผลกระทบจาก Noise
5. ถ้า ADC มี Resolution ต่ำ จะส่งผลอย่างไรต่อความแม่นยำ?
ADC ที่มี Resolution ต่ำจะสามารถแบ่งระดับแรงดันได้เป็นจำนวนขั้นน้อย ทำให้การแปลงสัญญาณอนาล็อกเป็นดิจิทัลมีความละเอียดต่ำ เกิดความคลาดเคลื่อนจากการ Quantization มากขึ้น และไม่สามารถตรวจจับการเปลี่ยนแปลงเล็ก ๆ ของสัญญาณได้ ส่งผลให้ความแม่นยำในการวัดและการวิเคราะห์ข้อมูลลดลง
