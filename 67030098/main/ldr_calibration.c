/*
 * LDR + Calibration — ESP32 (ESP-IDF)
 * 67030098
 *
 * อ่านค่า ADC จาก LDR (Voltage Divider กับ R คงที่ 10kΩ) บน GPIO34
 * แล้วแปลงค่า ADC -> Lux ด้วยสมการ Calibration ที่ได้จาก Trendline
 */
