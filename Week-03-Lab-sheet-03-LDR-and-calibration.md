...
| --- | -------------------------------------------------------------- | -------------------- | ------ |
| 1.1 | อธิบายหลักการทำงานของ LDR ได้ถูกต้อง                           | 3                    | ได้เข้าใจการทำงานมากขึ้นว่า ถ้าแสงมากความต้านทานจะลดลง และถ้าแสงน้อยความต้านทานจะมาก |
| 1.2 | อธิบายการทำงานภายใน LDR (โฟตอน → อิเล็กตรอน → conduction band) | 2                    | ไม่มั่นใจตรงที่สามารถอธิบายได้ชัดเจนเกี่ยวกับการทำงานของ LDR                         |
| 1.3 | เข้าใจว่าความสัมพันธ์ R vs Lux ไม่เป็นเส้นตรง                  | 1                    | ยังไม่สามารถเข้าใจได้มาก                                                             |
| 1.4 | เข้าใจเหตุผลที่ต้องใช้ Voltage Divider                         | 3                    | ทำหน้าที่แปลงค่าความต้านทาน ให้เป็นแรงดันไฟฟ้าเพื่อที่จะป้อนเข้าสู่ช่อง ADC          |

### **ส่วนที่ 10.2 — การต่อวงจรและอ่านค่า ADC (20 คะแนน)**

| ข้อ | รายการ                              | คะแนน<br>(0–5 คะแนน) | เหตุผล |
| --- | ----------------------------------- | -------------------- | ------ |
| 2.1 | ต่อวงจร Voltage Divider ได้ถูกต้อง  | 5                    | สามารถต่อได้อย่างถูกต้อง                           |
| 2.2 | เลือกค่า R คงที่เหมาะสม (เช่น 10kΩ) | 4                    | ช่วงแรกได้มีการเลือกค่าผิดบ้าง                     |
| 2.3 | เขียนโปรแกรมอ่านค่า ADC ได้ถูกต้อง  | 4                    | โค้ดสามารถทำงานได้อย่างถูกต้อง แม้อาจมี Error บ้าง |
| 2.4 | ใช้ ESP‑IDF ADC + Calibration ได้   | 4                    | สามารถเปิดใช้งาน Calibration  ได้                  |

### **ส่วนที่ 10.3 — การเก็บข้อมูลจริง (20 คะแนน)**

| ข้อ | รายการ                             | คะแนน<br>(0–5 คะแนน) | เหตุผล |
| --- | ---------------------------------- | -------------------- | ------ |
| 3.1 | เก็บข้อมูล ADC อย่างน้อย 5–7 จุด   | 4                    | สามารถบันทึกสภาพแสงได้ในพื้นที่แตกต่างได้บางส่วน                             |
| 3.2 | วัดค่า Lux จากมือถือได้ถูกต้อง     | 3                    | แอปบนมือถือที่ชื่อว่า Lux Meter มีการแกว่งของแสงตามมุมตกกระทบทำให้ค่าไม่นิ่ง |
| 3.3 | จดข้อมูลเป็นตารางครบถ้วน           | 5                    | จดได้ครบ                                                                     |
| 3.4 | ควบคุมสภาพแสงให้คงที่ระหว่างการวัด | 3                    | พยายามควบคุมแสงเท่าที่เป็นไปปได้แล้ว                                         |
...
| ข้อ | รายการ                                        | คะแนน<br>(0–5 คะแนน) | เหตุผล |
| --- | --------------------------------------------- | -------------------- | ------ |
| 4.1 | สร้างกราฟ Scatter ADC vs Lux ได้              | 5                    | สามารถสร้างใน Excell ได้                  |
| 4.2 | เลือก Trendline เหมาะสม (Linear / Polynomial) | 3                    | สามารถเลือกได้เหมาะสม                     |
| 4.3 | อ่านสมการจากกราฟได้ถูกต้อง                    | 3                    | สามารถดึงค่าสมาการคณิตศาสตร์ได้           |
| 4.4 | นำสมการไปใช้ในโค้ดได้                         | 4                    | สามารถแปลงสมาการมาอยู่ในรูปแบบโค้ดได้     |
| 4.5 | วิเคราะห์ว่า Linear หรือ Polynomial เหมาะกว่า | 4                    | แยกแยกได้ว่า Polynomial มีความเหมาะสมกว่า |
### **ส่วนที่ 10.5 — การทดสอบผลลัพธ์และวิเคราะห์ (15 คะแนน)**

| ข้อ | รายการ                                   | คะแนน<br>(0–5 คะแนน) | เหตุผล |
| --- | ---------------------------------------- | -------------------- | ------ |
| 5.1 | ทดสอบจุดแสงใหม่ที่ไม่ได้ใช้ตอนเก็บข้อมูล | 5                    | ด้ทำการทดสอบจุดที่ไม่ได้ใช้ตอนเก็บข้อมูลอย่างครบถ้วน                                       |
| 5.2 | เปรียบเทียบ Lux มือถือ vs Lux จากโค้ด    | 3                    | ค่า Lux จากโค้ดมีความแม่นยำกว่าการวัดด้วยโทรศัพท์มือถือ เนื่องจากมีความคลาดเคลื่อนน้อยกว่า |
| 5.3 | วิเคราะห์ความคลาดเคลื่อนและสาเหตุได้     | 4                    | สรุปว่าการคาดเคลื่อนเกิดจากข้อจำกัดเชิงเส้นของ Sensor และมุมตกกระทบของแสง                  |
.................................................................

###  **คะแนนรวมทั้งหมด:** ` 72 / 100`

###  **คำถามสะท้อนความเข้าใจ (Reflection)**

ให้นักศึกษาเขียนตอบสั้น ๆ

1. จุดไหนในใบงานที่คิดว่ายากที่สุด? การเก็บข้อมูลให้แสงคงที่ค่อนข้างยาก เพราะแสงเปลี่ยนตลอด ทำให้เลือก Trendline และหาสมการ Calibration ให้ตรงกับข้อมูลจริงได้ยาก
    
2. ถ้าทำใบงานนี้อีกครั้ง จะปรับปรุงอะไร? จะเก็บข้อมูลให้มากขึ้นและพยายามควบคุมแสงให้คงที่กว่าเดิม เพื่อให้ค่าที่ได้แม่นยำและสมการ Calibration ดีขึ้น
    
3. ส่วนไหนที่คิดว่าตนเองเข้าใจดีมาก? เข้าใจการต่อวงจร Voltage Divider และการเขียนโค้ดอ่านค่า ADC เพราะได้ลองทำเองจนสามารถใช้งานได้จริง
