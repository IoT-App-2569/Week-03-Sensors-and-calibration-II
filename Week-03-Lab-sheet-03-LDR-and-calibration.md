...
```
ผลลัพธ์บนแผนภูมิ
<img width="1836" height="734" alt="messageImage_1784476723731" src="https://github.com/user-attachments/assets/f2eb546e-ab1a-4e34-a501-77a7720b19a3" />
...
| ----------- | ---- | ---------- | ----------- |
| ใต้โต๊ะ     | 681  | 1        | 35.47          |
| ห้องเรียน   | 1339 | 13        | 129.11         |
| หน้าต่าง    | 3211 | 208        | 404.29         |

ให้นักศึกษาวิเคราะห์ว่า

- ความคลาดเคลื่อนอยู่ในระดับที่ยอมรับได้หรือไม่
  ยังอยู่ในระดับที่ยอมรับไม่ได้
- สมการ Linear หรือ Polynomial เหมาะกว่ากัน
  สมการ Polynomial เหมาะสมกว่ามาก
  
## **ส่วนที่ 8 — คำถามท้ายใบงาน**

1. ทำไมต้องใช้ Voltage Divider ในการอ่าน LDR?
ตอบ เพราะตัว LDR มันเปลี่ยนค่าตามความเข้มแสงในรูปของ ความต้านทาน (R) ครับ แต่โมดูล ADC ของไมโครคอนโทรลเลอร์มันรับอินพุตได้แค่ แรงดันไฟฟ้า (V) เราเลยต้องต่อวงจร Voltage Divider เพื่อแปลงค่า R ของ LDR ให้ทอนออกมาเป็นค่าแรงดัน ส่งเข้าขา ADC
2. ทำไมต้องเก็บข้อมูลหลายจุดก่อนทำ Calibration?
ตอบ เซนเซอร์จริงมันไม่ได้เป็นเส้นตรงเป๊ะ (Non-linear) การเก็บหลายจุดช่วยให้เราทำ Line Fitting หาค่าเฉลี่ยชดเชย Error ได้แม่นยำตลอดช่วงการใช้งาน ไม่ใช่แม่นแค่จุดเดียว
3. ถ้า Noise มากกว่าสัญญาณจริง จะเกิดอะไรขึ้น?
ตอบ สัญญาณจริงจะจมหายไปเลย (SNR < 1) ADC แยกแยะไม่ออกว่าไหนคือค่าจริงไหนคือคลื่นรบกวน ผลคือค่าจะแกว่งรุนแรงจนระบบเออร์เรอร์ ใช้งานไม่ได้
4. ทำไมการวางตำแหน่งเซนเซอร์จึงสำคัญต่อ Signal Integrity?
ตอบ สัญญาณแอนาล็อกมันดรอปและโดนกวนง่ายมาก ถ้าเดินสายยาวเกินไปแรงดันจะตก หรือถ้าไปวางใกล้พวกสายมอเตอร์หรือเสา Wi-Fi ก็จะโดนสัญญาณรบกวน (EMI) กวนจนเพี้ยนตั้งแต่ยังไม่ถึงชิป
5. ถ้า ADC มี Resolution ต่ำ จะส่งผลอย่างไรต่อความแม่นยำ?
ตอบ เกิด Quantization Error สูง เพราะระดับการแบ่งแรงดันมันหยาบ พอขั้นบันไดมันหยาบ ต่อให้เซนเซอร์ขยับเปลี่ยนค่านิดหน่อย ADC ก็จะมองไม่เห็น ความแม่นยำเลยต่ำลง
...
| 1.4 | เข้าใจเหตุผลที่ต้องใช้ Voltage Divider                         |            4          |        |
...
| 2.4 | ใช้ ESP‑IDF ADC + Calibration ได้   |           4           |        |
...
| 3.2 | วัดค่า Lux จากมือถือได้ถูกต้อง     |           5           |        |
...
| 4.2 | เลือก Trendline เหมาะสม (Linear / Polynomial) |           4           |        |
...
| 5.2 | เปรียบเทียบ Lux มือถือ vs Lux จากโค้ด    |           5           |        |
| 5.3 | วิเคราะห์ความคลาดเคลื่อนและสาเหตุได้     |           4           |        |
.................................................................
...
1. จุดไหนในใบงานที่คิดว่ายากที่สุด? การเลือกชนิดของ Trendline ให้แมตช์กับข้อมูลดิบตอนทำ Calibration และการแก้โค้ด ADC ให้รองรับระบบบอร์ด
    
2. ถ้าทำใบงานนี้อีกครั้ง จะปรับปรุงอะไร? จะเก็บข้อมูลดิบ ให้มากกว่า 5-7 จุด และคุมแสงรบกวนรอบข้างให้ดีขึ้น เพื่อให้สมการ Calibration แม่นยำกว่าเดิม
    
3. ส่วนไหนที่คิดว่าตนเองเข้าใจดีมาก? เรื่องการทดสอบและเปรียบเทียบค่า Lux ระหว่างแอปในมือถือกับค่าที่คำนวณได้จากโค้ดครับ เห็นภาพชัดเจนและวิเคราะห์ความคลาดเคลื่อนได้ง่ายที่สุด
