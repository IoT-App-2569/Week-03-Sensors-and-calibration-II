...
| --- | -------------------------------------------------------------- | -------------------- | ------ |
| 1.1 | อธิบายหลักการทำงานของ LDR ได้ถูกต้อง                           | 4 | อธิบายหลักการเปลี่ยนความต้านทานตามความเข้มแสงได้เข้าใจดี |
| 1.2 | อธิบายการทำงานภายใน LDR (โฟตอน → อิเล็กตรอน → conduction band) | 3 | อธิบายกระบวนการในสารกึ่งตัวนำได้พอสังเขป |
| 1.3 | เข้าใจว่าความสัมพันธ์ R vs Lux ไม่เป็นเส้นตรง                  | 4 | เข้าใจพฤติกรรมเชิงเส้นโค้งแบบ Power Law ได้ถูกต้อง |
| 1.4 | เข้าใจเหตุผลที่ต้องใช้ Voltage Divider                         | 4 | อธิบายการแปลงความต้านทานเป็นแรงดันไฟฟ้าสำหรับ ADC ได้ชัดเจน |

### **ส่วนที่ 10.2 — การต่อวงจรและอ่านค่า ADC (20 คะแนน)**

| ข้อ | รายการ                              | คะแนน<br>(0–5 คะแนน) | เหตุผล |
| --- | ----------------------------------- | -------------------- | ------ |
| 2.1 | ต่อวงจร Voltage Divider ได้ถูกต้อง  | 4 | ต่อวงจรแบ่งแรงดันตามสเกมาติกได้ถูกต้องเรียบร้อย |
| 2.2 | เลือกค่า R คงที่เหมาะสม (เช่น 10kΩ) | 4 | เลือกใช้ R 10kΩ เหมาะสมกับช่วงการทำงานของ LDR |
| 2.3 | เขียนโปรแกรมอ่านค่า ADC ได้ถูกต้อง  | 4 | เขียนโค้ดอ่านค่า raw ADC จาก ESP32 ได้ตามวัตถุประสงค์ |
| 2.4 | ใช้ ESP‑IDF ADC + Calibration ได้   | 3 | อ่านและใช้งานฟังก์ชัน Calibration ของ ESP-IDF ได้ตามตัวอย่าง |

### **ส่วนที่ 10.3 — การเก็บข้อมูลจริง (20 คะแนน)**

| ข้อ | รายการ                             | คะแนน<br>(0–5 คะแนน) | เหตุผล |
| --- | ---------------------------------- | -------------------- | ------ |
| 3.1 | เก็บข้อมูล ADC อย่างน้อย 5–7 จุด   | 4 | เก็บข้อมูลสภาพแสงได้ครบ 5 จุดวัดตามที่กำหนด |
| 3.2 | วัดค่า Lux จากมือถือได้ถูกต้อง     | 4 | ใช้แอป Lux Meter อ่านค่าตรงตำแหน่งเซนเซอร์ได้เหมาะสม |
| 3.3 | จดข้อมูลเป็นตารางครบถ้วน           | 4 | บันทึกข้อมูล ADC และ Lux ลงในตารางได้ครบถ้วน |
| 3.4 | ควบคุมสภาพแสงให้คงที่ระหว่างการวัด | 3 | ควบคุมสภาพแสงได้ในระดับหนึ่ง แต่ยังมีแสงสะท้อนรบกวนบ้าง |
...
| ข้อ | รายการ                                        | คะแนน<br>(0–5 คะแนน) | เหตุผล |
| --- | --------------------------------------------- | -------------------- | ------ |
| 4.1 | สร้างกราฟ Scatter ADC vs Lux ได้              | 4 | พล็อต Scatter Plot บน Excel ได้ถูกต้อง |
| 4.2 | เลือก Trendline เหมาะสม (Linear / Polynomial) | 4 | พิจารณาค่า $R^2$ และเลือกประเภท Trendline ได้เหมาะสม |
| 4.3 | อ่านสมการจากกราฟได้ถูกต้อง                    | 4 | ดึงสมการความสัมพันธ์และค่าความชันจากกราฟได้ถูกต้อง |
| 4.4 | นำสมการไปใช้ในโค้ดได้                         | 4 | แปลงสมการไปใช้ในโค้ดภาษา C ได้ถูกต้อง |
| 4.5 | วิเคราะห์ว่า Linear หรือ Polynomial เหมาะกว่า | 3 | เปรียบเทียบความแม่นยำของสมการได้ในระดับพอใช้ |

### **ส่วนที่ 10.5 — การทดสอบผลลัพธ์และวิเคราะห์ (15 คะแนน)**

| ข้อ | รายการ                                   | คะแนน<br>(0–5 คะแนน) | เหตุผล |
| --- | ---------------------------------------- | -------------------- | ------ |
| 5.1 | ทดสอบจุดแสงใหม่ที่ไม่ได้ใช้ตอนเก็บข้อมูล | 4 | ทดสอบสุ่มวัดที่ 3 สภาพแสงใหม่ได้เรียบร้อย |
| 5.2 | เปรียบเทียบ Lux มือถือ vs Lux จากโค้ด    | 4 | ค่าที่อ่านได้จากโค้ดกับมือถือใกล้เคียงกัน |
| 5.3 | วิเคราะห์ความคลาดเคลื่อนและสาเหตุได้     | 3 | วิเคราะห์ปัจจัย Noise และข้อจำกัดของเซนเซอร์ได้พอสังเขป |
...
การปรับเลือกประเภทสมการ Calibration และการควบคุมแสงแวดล้อมให้คงที่ขณะเก็บข้อมูล
    
2. ถ้าทำใบงานนี้อีกครั้ง จะปรับปรุงอะไร? 
จะเพิ่มจำนวนจุดข้อมูลวัดแสงให้ถี่ขึ้น และจัดเตรียมกล่องควบคุมแสงปิดสนิทเพื่อลดแสงสะท้อนรบกวน
    
3. ส่วนไหนที่คิดว่าตนเองเข้าใจดีมาก? 
การต่อวงจร Voltage Divider และการนำสมการที่ได้จาก Excel ไปแปลงลงโค้ด C บน ESP32
