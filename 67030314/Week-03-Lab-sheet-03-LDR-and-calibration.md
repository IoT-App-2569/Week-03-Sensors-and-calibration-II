...
| -------- | ------------- | ---------------------- |
| มืดสนิท  | 200 kΩ – 2 MΩ | 11 mV                  |
| ห้องปกติ | 10 kΩ – 50 kΩ | 2.357 V                |
| ใต้โคมไฟ | 2 kΩ – 10 kΩ  | 2.750 V                |
| กลางแจ้ง | 200 Ω – 2 kΩ  | 3.242 V                |
...
| ----------- | ---- | ---------- | ----------- |
| ใต้โต๊ะ     | 600  | 40         | 45          |
| ห้องเรียน   | 1500 | 180        | 90          |
| หน้าต่าง    | 2800 | 500        | 138         |
...
| --- | -------------------------------------------------------------- | -------------------- | ------------------------------------------------------------------------------------- |
| 1.1 | อธิบายหลักการทำงานของ LDR ได้ถูกต้อง                           | 4                    | เข้าใจว่าแสงมากความต้านทานลด แสงน้อยความต้านทานเพิ่ม                                  |
| 1.2 | อธิบายการทำงานภายใน LDR (โฟตอน → อิเล็กตรอน → conduction band) | 3                    | ยังไม่มั่นใจในการอธิบายการทำงานของ LDR ได้อย้่างชัดเจน                                |
| 1.3 | เข้าใจว่าความสัมพันธ์ R vs Lux ไม่เป็นเส้นตรง                  | 2                    | ยังไม่ค่อยเข้าใจความสัมพันธ์ของ R และ Lux                                             |
| 1.4 | เข้าใจเหตุผลที่ต้องใช้ Voltage Divider                         | 4                    | Voltage Divider มาทำหน้าที่แปลงค่าความต้านทานให้เป็นแรงดันไฟฟ้าเพื่อป้อนเข้าสู่ขา ADC |

### **ส่วนที่ 10.2 — การต่อวงจรและอ่านค่า ADC (20 คะแนน)**

| ข้อ | รายการ                              | คะแนน<br>(0–5 คะแนน) | เหตุผล                          |
| --- | ----------------------------------- | -------------------- | ------------------------------- |
| 2.1 | ต่อวงจร Voltage Divider ได้ถูกต้อง  | 5                    | ต่อวงจรบน Breadboard ได้ถูกต้อง |
| 2.2 | เลือกค่า R คงที่เหมาะสม (เช่น 10kΩ) | 5                    | เลือกค่าได้ถูกต้อง              |
| 2.3 | เขียนโปรแกรมอ่านค่า ADC ได้ถูกต้อง  | 5                    | โค้ดทำงานได้สมบูรณ์ถูกต้อง      |
| 2.4 | ใช้ ESP‑IDF ADC + Calibration ได้   | 5                    | เปิดใช้งานฟังก์ชัน Calibration  |

### **ส่วนที่ 10.3 — การเก็บข้อมูลจริง (20 คะแนน)**

| ข้อ | รายการ                             | คะแนน<br>(0–5 คะแนน) | เหตุผล                                                                     |
| --- | ---------------------------------- | -------------------- | -------------------------------------------------------------------------- |
| 3.1 | เก็บข้อมูล ADC อย่างน้อย 5–7 จุด   | 5                    | บันทึกข้อมูลสภาพแสงที่แตกต่างกันครบถ้วนตามเกณฑ์ใบงาน                       |
| 3.2 | วัดค่า Lux จากมือถือได้ถูกต้อง     | 3                    | แอป Lux Meter บนมือถือมีการแกว่งของค่าตามมุมตกกระทบ ทำให้อ่านค่าให้นิ่งยาก |
| 3.3 | จดข้อมูลเป็นตารางครบถ้วน           | 5                    | บันทึกค่าได้ครบถ้วน                                                        |
| 3.4 | ควบคุมสภาพแสงให้คงที่ระหว่างการวัด | 4                    | พยายามบังแสงแล้ว แต่ยังมีแสงสะท้อนเปลี่ยนไปเล็กน้อย                        |
...
| ข้อ | รายการ                                        | คะแนน<br>(0–5 คะแนน) | เหตุผล                                                                     |
| --- | --------------------------------------------- | -------------------- | -------------------------------------------------------------------------- |
| 4.1 | สร้างกราฟ Scatter ADC vs Lux ได้              | 5                    | สร้างกราฟใน Excel ได้                                                      |
| 4.2 | เลือก Trendline เหมาะสม (Linear / Polynomial) | 4                    | เลือกกราฟได้เหมาะสม                                                        |
| 4.3 | อ่านสมการจากกราฟได้ถูกต้อง                    | 3                    | ดึงค่าสมการออกมาได้ แต่อาจมีงงเรื่องการปัดทศนิยมตำแหน่งท้ายๆ ของค่าความชัน |
| 4.4 | นำสมการไปใช้ในโค้ดได้                         | 4                    | แปลงสมการคณิตศาสตร์มาเขียนเป็นรูปแบบโค้ดได้                                |
| 4.5 | วิเคราะห์ว่า Linear หรือ Polynomial เหมาะกว่า | 4                    | สามารถแยกแยะได้ว่า Polynomial เข้าใกล้ 1.000 มากกว่า                       |
### **ส่วนที่ 10.5 — การทดสอบผลลัพธ์และวิเคราะห์ (15 คะแนน)**

| ข้อ | รายการ                                   | คะแนน<br>(0–5 คะแนน) | เหตุผล                                                                                   |
| --- | ---------------------------------------- | -------------------- | ---------------------------------------------------------------------------------------- |
| 5.1 | ทดสอบจุดแสงใหม่ที่ไม่ได้ใช้ตอนเก็บข้อมูล | 5                    | ได้ทำการทดสอบจุดที่ไม่ได้ใช้ตอนเก็บข้อมูลอย่างครบถ้วน                                    |
| 5.2 | เปรียบเทียบ Lux มือถือ vs Lux จากโค้ด    | 4                    | Lux จากโค้ดจะมีความแม่นยำกว่า Lux มือถือเนื่องจากค่าไม่คลาดเคลื่อนเท่ากับการวัดจากมือถือ |
| 5.3 | วิเคราะห์ความคลาดเคลื่อนและสาเหตุได้     | 4                    | สามารถสรุปได้ว่าคลาดเคลื่อนเกิดจากข้อจำกัดเชิงเส้นของเซนเซอร์และมุมตกกระทบของแสง         |
...
1. จุดไหนในใบงานที่คิดว่ายากที่สุด? การควบคุมแสงตอนเก็บข้อมูลให้นิ่ง และการเลือกชนิดของ Trendline ใน Excel ให้ดัดโค้งตรงตามพฤติกรรมจริงของ LDR เพื่อหาสมการแปลงค่า
    
2. ถ้าทำใบงานนี้อีกครั้ง จะปรับปรุงอะไร? จะเพิ่มจำนวนจุดจัดเก็บข้อมูลสภาพแสงเป็น 10 จุด เพื่อให้กราฟและสมการ Calibration คำนวณค่า Lux ออกมาได้แม่นยำยิ่งขึ้น
    
3. ส่วนไหนที่คิดว่าตนเองเข้าใจดีมาก? ส่วนการต่อวงจร Voltage Divider บน Breadboard และการเขียนโค้ดภาษา C เพื่อเรียกอ่านค่า ADC ของบอร์ดไมโครคอนโทรลเลอร์
